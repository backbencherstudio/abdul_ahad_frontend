        ...
        <div className="flex items-center">
          {row.avatar_url ? (
            <div className="relative h-10 w-10 mr-3">
              ...
              />
              <div className="avatar-fallback h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center absolute top-0 left-0 hidden">
