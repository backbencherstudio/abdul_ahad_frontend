...
import { useGetGarageSlotsQuery, useBookSlotMutation } from '@/rtk/api/driver/bookMyMotApi'
import { selectVehicle, setSelectedSlot, selectSelectedSlot } from '@/rtk/slices/driver/bookMyMotSlice'
