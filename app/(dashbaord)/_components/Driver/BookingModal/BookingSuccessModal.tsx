            ...
            <div className=" text-white rounded-lg overflow-hidden">
                ...
                <div className="relative p-6">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-xl font-bold mb-2 text-green-500">MOT Booking is Complete!</h2>
                        <p className="text-gray-500">Thank you for booking with us.</p>
                    </div>

                    {/* Booking Details */}
                    {submittedBooking && selectedSlot && (
                        <div className="space-y-3 mb-6 text-sm">
                            <div>
                                <span className="text-gray-400">Date: </span>
                                <span className="text-white">
                                    {selectedDate ? format(selectedDate, "dd MMMM yyyy") : submittedBooking.date}
                                </span>
                            </div>
                            <div>
