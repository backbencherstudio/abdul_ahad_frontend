        ...
        <div className="w-64 h-screen bg-white flex flex-col">
            ...
            <div className=" p-4">
                <button
                    ...
                    className="flex items-center cursor-pointer w-full px-4 py-2 text-[#FF7500] hover:bg-[#FF7500] hover:text-white rounded-md transition-colors duration-300 group"
                >
