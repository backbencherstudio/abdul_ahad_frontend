...
export const subscriptionApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getSubscriptionPlans: builder.query<PlansResponse, { page?: number; limit?: number }>({
            query: ({ page = PAGINATION_CONFIG.DEFAULT_PAGE, limit = PAGINATION_CONFIG.DEFAULT_LIMIT }) => ({
