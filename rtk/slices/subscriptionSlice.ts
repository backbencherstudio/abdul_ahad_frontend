...
import { SubscriptionPlan } from '../api/garage/subscriptionApis';
...
export const { setSelectedPlan, setCheckoutLoading, updateSubscriptionStatus } = subscriptionSlice.actions;
